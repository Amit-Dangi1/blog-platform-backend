...
export class AdminController extends BaseController {
  constructor(private readonly adminService: AdminService,private readonly userService:UsersService) {
    super();
  }
  ...
  @Patch("update/userrole/:id")
  async updateUserRole(@Param("id",ParseIntPipe)id:number){
        return this.userService.updateUserRoleByAdmin(id)
  }
}
