...
import { JwtPayload, Role1, UserType } from '@Common';
...
import { OtpTransport, Role, User } from '../generated/prisma/client';
...
export class AuthService {
  ...
  async login(userId: number, type: UserType,role:Role): Promise<ValidAuthResponse> {
